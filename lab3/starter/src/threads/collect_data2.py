...
def generate_stats_table():
    ...
    '''
    with open('lab3-stats2.csv', 'w') as file:
    ...
    print 'Written the statistics out to lab3-stats2.csv'

def dump_raw_times():
    '''
    Writes the raw times to a csv file
    '''
    with open('lab3-times2.csv', 'w') as file:
        for k in times:
            t = str(k['times'])
            file.write('{},{}\n'.format(k['cmd'],t[1:-1]))
    print 'Written the raw times out to lab3-times2.csv'
